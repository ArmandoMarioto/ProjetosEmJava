 ...
 * @author Luish
 */
public class TelaGenClienteController implements Initializable
{
    ...
    private void evtBuscaCep(ActionEvent event)
    {
        ...
        //cbcidade.setSelectionModel(my_obj.getString("city"));
    ...
    private boolean validaCampos()
    {
        ...
        if (trg.getText().length() < 13 || trg.getText().length() > 14)
        {
            lblErroRG.setText("Dígitos Insuficiente (13 à 14)");
        ...
        {
            lblErroCPF.setText("CPF/CNPJ Inválido!!!");
    ...
    private void CarregaTabela(String filtro)
    {
        ...
        ObservableList<Object> ob = FXCollections.observableArrayList(CtrCliente.GetListaCliente(filtro, cbbusca.getSelectionModel().getSelectedItem()));
        tabela.setItems(ob);
    }
