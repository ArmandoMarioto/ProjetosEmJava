...
public class TelaGenProdutoController implements Initializable
{
        ...
        if (CamposValidos())
        {
            if (tcodigo.getText().isEmpty())//novo
            {
                ...
                if (CtrProduto.SalvarProduto(tnome.getText(), Double.parseDouble(tpreco.getText().replace(".", "").replace(",", ".")),
                        ...
                        cbtipo.getSelectionModel().getSelectedItem(), Integer.parseInt(tquantidade.getText()), tobs.getText()))
                {
    ...
    private void CarregaTabela(String filtro)
    {
        ...
        ObservableList<Object> ob = FXCollections.observableArrayList(CtrProduto.instancia().getLista(filtro, cbbusca.getSelectionModel().getSelectedItem()));
        tabela.setItems(ob);
    }
