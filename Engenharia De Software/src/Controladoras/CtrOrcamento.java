...
public class CtrOrcamento implements Controladora
{
    ...
    public static Boolean Alterar(int c_orcamento, int codigo_cliente, LocalDate dtorcamento, LocalDate dtvalidade, Double total, String obs, int id_funcionario, ObservableList<Object> produtos, ObservableList<Object> servicos)
    {
        ...
        try
        {
            ...
            o = new Orcamento(c_orcamento, Date.valueOf(dtorcamento),
    ...
    {
        Double c = 0.0;
        //ObservableList<ItemOrcamentoProduto> p = (ObservableList<ItemOrcamentoProduto>)cbprodutos.getItems();
        //ItemOrcamentoProduto p = (ItemOrcamentoProduto)cbprodutos;
