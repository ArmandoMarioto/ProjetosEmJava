...
public class Funcionario
{
    ...
    public Funcionario(int codigo, String nome, String funcao, String rua, String bairro, String cidade, Date nascimento, boolean sexo)
    {
        this.codigo = codigo;
        this.nome = nome;
        this.funcao = funcao;
    ...
    public Funcionario(int codigo, String nome, String funcao, String telefone, String celular, String email, String rua, String bairro, String cidade, Date nascimento, boolean sexo)
    {
        this.codigo = codigo;
        this.nome = nome;
        this.funcao = funcao;
