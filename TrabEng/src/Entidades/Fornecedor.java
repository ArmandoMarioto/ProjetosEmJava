...
public class Fornecedor
{
    ...
    public boolean Salvar(String sql) throws SQLException
    {
        ...
        return Banco.BD.getCon().manipular(sql);
    }
    ...
    {
        sql = "DELETE FROM fornecedor WHERE for_cod = " + getCodigo();
    ...
    public ObservableList<Fornecedor> Buscar(String filtro , String busca)
    {
        ...
        ResultSet rs = Banco.BD.getCon().consultar("SELECT * FROM fornecedor WHERE " + busca +" LIKE '" + filtro +"%"+ "'");
    ...
    public ObservableList<Fornecedor> BuscarTodos()
    {
        ...
        ResultSet rs = Banco.BD.getCon().consultar("SELECT * FROM fornecedor");
